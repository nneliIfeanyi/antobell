                    ...
                    <section class="rounded-[2rem] border border-white/10 bg-white/95 p-7 text-slate-900 shadow-soft backdrop-blur sm:p-8">
                        ...
                        <form id="adminLoginForm" class="mt-8 space-y-5">
                            <label class="block space-y-2">
                                ...
                                <input name="email" type="email" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-brand-500" required aria-label="Admin email" />
                            </label>
                            <label class="block space-y-2">
                                <span class="text-sm font-medium text-slate-700">Password</span>
                                <input name="password" type="password" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-brand-500" required aria-label="Admin password" />
                            </label>
